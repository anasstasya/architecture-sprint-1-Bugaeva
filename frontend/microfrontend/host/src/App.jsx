...
import AddPlacePopup from "../../card_mf/src/components/AddPlacePopup.js";
...
const CheckToken = lazy(() => import('auth_mf/CheckToken').catch(() => {
  return { default: () => <div className='error'>Component CheckToken is not available!</div> };
}));
